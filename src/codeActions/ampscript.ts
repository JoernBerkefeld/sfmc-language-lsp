...
export function getAmpscriptCodeActions(
    ...
    for (const diagnostic of diagnostics) {
        ...
        actions.push(...buildActionsForDiagnostic(text, uri, diagnostic));
    }
...
/**
 * Build the quick-fix code actions for a single AMPscript diagnostic.
 * @param text - Full document text.
 * @param uri - Document URI.
 * @param diagnostic - The diagnostic to generate actions for.
 * @returns Zero or more code actions for the diagnostic.
 */
function buildActionsForDiagnostic(
    text: string,
    uri: string,
